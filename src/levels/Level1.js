...
export default class Level1 extends Level {
    ...
    createPlatforms() {
        ...
        this.platforms = [
            ...
            new Platform(this.game, 400, height - 240, 130, 200, grass),
            new Platform(this.game, 250, height - 150, 70, 50, grass),
            new Platform(this.game, 125, height - 350, 100, 50 , grass),
    ...
    createEnemies() {
        ...
        this.enemies = [
            ...
            new Enemy(this.game, 155, height -  390, 40, 40, 0),
